...
| [content-quality-check](content-quality-check/) | Editorial QA pass before publishing: a deterministic linter for AI tells, template language, and the brand's own Avoid list, plus an editorial judgment pass for openers, closers, proof, and voice conformance, with a fix per flag | Shipped |
